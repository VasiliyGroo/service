...
$document = new \PhpOffice\PhpWord\TemplateProcessor("./word/act-corpus-section20.docx");
...
$uploadFileQ = $uploadDir . '\\' . basename($_FILES['file_q']['name']);
move_uploaded_file($_FILES['file_q']['tmp_name'], $uploadFileQ);

$uploadFileR = $uploadDir . '\\' . basename($_FILES['file_r']['name']);
move_uploaded_file($_FILES['file_r']['tmp_name'], $uploadFileR);

$uploadFileS = $uploadDir . '\\' . basename($_FILES['file_s']['name']);
move_uploaded_file($_FILES['file_s']['tmp_name'], $uploadFileS);
...
$description_problem_q = $_POST['description_problem_q'];
$description_problem_r = $_POST['description_problem_r'];
$description_problem_s = $_POST['description_problem_s'];
...
$image_q = $_POST['image_q'];
$image_r = $_POST['image_r'];
...
$document -> setValue('description_problem_q', $description_problem_q);
$document -> setValue('description_problem_r', $description_problem_r);
$document -> setValue('description_problem_s', $description_problem_s);
...
$document -> setImageValue('image_q', array('path' => $uploadFileQ, 'width' => 305, 'height' => 330, 'ratio' => false));
$document -> setImageValue('image_r', array('path' => $uploadFileR, 'width' => 305, 'height' => 330, 'ratio' => false));
$document -> setImageValue('image_s', array('path' => $uploadFileS, 'width' => 305, 'height' => 330, 'ratio' => false));
